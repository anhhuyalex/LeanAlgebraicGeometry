...
\begin{definition}[Ambient moduli and height data]
  ...
  \uses{def:Mg_level,def:universal_curve,def:Ag_level,def:universal_av,def:torelli_map,def:nt_height,def:height_fib}
...
\begin{lemma}[Height comparison on the moduli side]
  ...
  \uses{def:ambient_setup,def:torelli_map}
