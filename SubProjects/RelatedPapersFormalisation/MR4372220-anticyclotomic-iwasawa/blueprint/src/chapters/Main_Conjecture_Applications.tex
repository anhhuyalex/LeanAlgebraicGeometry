...
\section{The \texorpdfstring{$p$}{p}-converse to Gross--Zagier--Kolyvagin}
...
\section{The \texorpdfstring{$p$}{p}-part of the BSD formula in analytic rank~\texorpdfstring{$1$}{1}}
