...
\begin{lemma}[Monoidal localization transport]
  ...
  % Mathlib pointers: Localization/Monoidal/Basic.lean
  %   MorphismProperty.IsMonoidal (class, fields whiskerLeft/whiskerRight) L44;
  %   IsMonoidal.mk' builder L50; LocalizedMonoidal type synonym + associator L165,
  %   monoidalCategoryStruct L172, strong-monoidal comparison mu L184.
  %   Localization/Monoidal/Braided.lean: braided/symmetric transport.
  %   Sheaf precedent Sites/Monoidal.lean: Sheaf.monoidalCategory L165,
  %   braidedCategory L174, symmetricCategory L182.
  ...
  (the two fields of the class, assembled by the builder
  \(\mathrm{IsMonoidal.mk'}\)). Let \(L : \mathcal{C} \to \mathcal{D}\) be a
...
\begin{lemma}[Module sheafification is a monoidal localization input]
  ...
  % Mathlib pointers: ModuleCat/Sheaf/Localization.lean
  %   sheafification is a localization for J.W.inverseImage (toPresheaf R0) L48;
  %   inverseImage_W_toPresheaf_eq_inverseImage_isomorphisms L38.
  %   PresheafOfModules/Presheaf/Monoidal.lean: symmetric monoidal presheaves L144.
