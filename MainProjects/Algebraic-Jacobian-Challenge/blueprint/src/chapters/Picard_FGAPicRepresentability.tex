...
after the run-0008 rewire, \textbf{three} open sorries, each isolated in a
...
typeclasses are kernel-clean. The closed items of the former accounting:
the relative Picard functor carrier is REAL
(\cref{def:pic_sharp_carrier}), the representability identification is
PROVED (\cref{def:inst_pic_sharp_representable}), the group-scheme
structure is PROVED (\cref{thm:pic_is_group_scheme}), and the false global
