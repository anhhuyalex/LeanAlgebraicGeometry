...
[Gate: the \(\mathbb{P}^1\) chart-ring computation]
  ...
  for the pullback model, dischargeable via the flat-base-change section
  ladder of \Cref{thm:quot_pullback_baseMap_sectionEquiv_qc}. No instance
  of the class is supplied here.
\end{definition}
...
[Tier 1 deliverable: \(\genus C\) is honest]
  ...
  \lean{AlgebraicGeometry.Adelic.module_finite_genus,
    AlgebraicGeometry.Adelic.module_finite_hModule_one_of_finite_map}
